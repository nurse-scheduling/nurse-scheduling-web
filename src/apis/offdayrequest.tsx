...
export function useFetchOffDays(page: number, size: number, credentials: string, status: string, sort?: string, order?: string) {
...
export const updateOffDayStatus= async (id: string, status: string, credentials: string)=> {
